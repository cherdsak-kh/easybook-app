    ...
    groups: [
      {
        ...
        items: [
          ...
          'หน้าการเชื่อมต่อระบบ (System Integrations) — ตรวจสอบสถานะจริงของ LINE, Cloudflare R2, PostgreSQL และ Redis พร้อมปุ่มทดสอบแต่ละบริการ ตรวจสอบ Token และโควต้าข้อความ LINE โดยไม่ใช้โควต้า และสลับเปิด/ปิด Swagger UI (/docs, /docs-json) ได้ทันทีโดยไม่ต้องรีสตาร์ตเซิร์ฟเวอร์ (ค่าเริ่มต้นปิด) · แก้ไข Channel ID, Channel Secret และ Access Token ของ LINE ได้เฉพาะผู้ดูแลระบบสูงสุด',
        ],
      },
      {
        t: 'ปรับปรุง',
        items: ['ถอดหน้าเทมเพลตข้อความ (Message Templates) ออกจากระบบอย่างเป็นทางการ'],
      },
    ],
  },
  {
