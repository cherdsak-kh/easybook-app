    ...
    groups: [
      {
        t: 'ใหม่',
        items: [
          'หน้าประกาศและข่าวสาร (/backend/announcements) — หน้าจอจัดการประกาศและข่าวสารพร้อมตารางประวัติประกาศ แท็บกรองสถานะ (ทั้งหมด/ส่งแล้ว/ฉบับร่าง) ช่องค้นหาหัวข้อ การ์ดเชื่อมต่อข้อมูลสด LINE Official Account (แสดงชื่อ รูปโปรไฟล์ Basic ID สถานะการเชื่อมต่อ และปุ่มเปิด chat.line.biz) และคลังข้อความตอบกลับด่วนพร้อมปุ่มคัดลอก (ผู้ดูข้อมูลเปิดอ่านได้อย่างเดียว)',
        ],
      },
    ],
  },
