    ...
    groups: [
      {
        t: 'ใหม่',
        items: [
          'หน้าศูนย์การแจ้งเตือนเจ้าหน้าที่ (/backend/notifications) — หน้าจอจัดการการแจ้งเตือนครบวงจรพร้อมแท็บกรอง 5 หมวดหมู่ (ทั้งหมด/คำขอจอง/การลงทะเบียน/ข้อเสนอแนะ/ระบบ) ตัวนับจำนวนที่ยังไม่อ่านสด ตัวกรองสถานะและช่วงเวลาแบบ Combobox แถบค้นหา และการแบ่งหน้ามาตรฐาน 10/20/50 แถวต่อหน้า',
          'ระบบจัดการการแจ้งเตือนแบบกลุ่ม (Bulk Actions) — รองรับการเลือกทำเครื่องหมายอ่านแล้วหลายรายการ การซ่อนรายการที่เลือก และปุ่มลบรายการที่อ่านแล้วทั้งหมด พร้อมกล่องยืนยันก่อนลบ (ConfirmModal)',
          'แผงกระดิ่งแจ้งเตือนด่วนบนแถบด้านบน (Topbar Notification Bell & Quick-Peek) — แสดงตัวเลขแจ้งเตือนคงค้างสดบนระฆัง (สูงสุด 9+) รายการแจ้งเตือนล่าสุด 5 รายการ ปุ่มทำเครื่องหมายว่าอ่านแล้วทั้งหมด และปุ่มเปิดดูการแจ้งเตือนทั้งหมด',
        ],
      },
      {
        t: 'ปรับปรุง',
        items: [
          'ปรับปรุงการจัดวางการ์ดในหน้าการเชื่อมต่อระบบ (System Integrations) — สลับนำการ์ดสถานะหลัก LINE Official Account และ โครงสร้างพื้นฐาน (PostgreSQL/Redis) ขึ้นแสดงที่แถวบนสุด เพื่อให้ตรวจสอบสถานะการทำงานจริงของระบบได้ทันที',
        ],
      },
      {
        t: 'แก้ไข',
        items: [
          'ระบบจัดการประเภทสถานที่ — แก้ไขข้อผิดพลาดเมื่อลบประเภทสถานที่ในฐานข้อมูลที่ไม่มีหมวดหมู่สำรอง (Tombstone) โดยระบบจะสร้างให้อัตโนมัติและดำเนินการลบสำเร็จทันที',
          'หน้าข้อมูลเวอร์ชันระบบ — แก้ไขการแสดงผลหมายเลขการคอมไพล์ (Build Commit Hash) ของหน้าเว็บให้แสดงค่าสั้นจาก Git ได้ถูกต้องเมื่อ Deploy ผ่าน Docker และ CI/CD แทนการแสดงคำว่า unknown',
        ],
      },
    ],
  },
    ...
    groups: [
      {
        t: 'ใหม่',
        items: [
          'หน้าประกาศและข่าวสาร (/backend/announcements) — จัดการประกาศข่าวสารครบวงจรพร้อมตารางประวัติประกาศ แท็บกรองสถานะ (ทั้งหมด/ส่งแล้ว/ฉบับร่าง) ช่องค้นหา และการ์ดแสดงสถานะสด LINE Official Account พร้อมปุ่มเปิดห้องแชท chat.line.biz (ผู้ดูข้อมูลเปิดอ่านได้อย่างเดียว)',
          'หน้าต่างสร้าง/แก้ไขประกาศ (Announcement Dialog) และตัวจำลองหน้าจอมือถือ LINE แบบเรียลไทม์ — รองรับทั้งข้อความธรรมดาและการ์ด Flex Message พร้อมระบุกลุ่มเป้าหมาย (บุคลากรทั้งหมด หรือเลือกเฉพาะกลุ่ม/ฝ่าย) ตัวนับตัวอักษร และระบบป้องกันการส่งซ้ำ (Idempotency)',
          'ระบบส่งประกาศและกระจายข่าวสาร (Broadcast Delivery) — ส่งข้อความหรือ Flex Card ไปยังผู้ใช้ LINE ที่ได้รับอนุญาต พร้อมกล่องยืนยันก่อนส่ง และรองรับการบันทึกสถานะส่งสำเร็จอย่างราบรื่นแม้อยู่ในกรณีที่ผู้ใช้ปิดรับการแจ้งเตือนทั้งหมด (Zero Recipients)',
          'ระบบจัดการข้อความตอบกลับด่วน (Canned Replies Management) — บันทึก แก้ไข และลบข้อความตอบกลับด่วนสำหรับคัดลอกไปใช้ในแชท LINE OA สูงสุด 5 ข้อความ พร้อมตัวนับจำนวนและระบบป้องกันข้อมูลชนกัน (Table Lock)',
          'ระบบลบประกาศแบบ Soft Delete — รองรับการลบประกาศทั้งสถานะฉบับร่างและประกาศที่ส่งแล้ว โดยยังคงเก็บประวัติไว้ในฐานข้อมูลเพื่อการตรวจสอบย้อนหลัง',
          'ระบบสร้าง QR Code บัญชีทางการ LINE แบบไดนามิก (Dynamic LINE OA QR Code) — วาดภาพ QR Code แบบเรียลไทม์บนเบราว์เซอร์จาก Basic ID ปัจจุบัน พร้อมปุ่มคัดลอกลิงก์เพิ่มเพื่อนและปุ่มดาวน์โหลดไฟล์ภาพ PNG รองรับธีมมืดและขอบ Quiet Zone เพื่อให้สแกนติดง่าย 100%',
          'หน้าการเชื่อมต่อระบบ (System Integrations) — ตรวจสอบสถานะจริงของ LINE, Cloudflare R2, PostgreSQL และ Redis พร้อมปุ่มทดสอบแต่ละบริการ ตรวจสอบ Token และโควต้าข้อความ LINE โดยไม่ใช้โควต้า และสลับเปิด/ปิด Swagger UI (/docs, /docs-json) ได้ทันทีโดยไม่ต้องรีสตาร์ตเซิร์ฟเวอร์ (ค่าเริ่มต้นปิด)',
        ],
      },
      {
        t: 'ปรับปรุง',
        items: [
          'ถอดหน้าเทมเพลตข้อความ (Message Templates) ออกจากระบบอย่างเป็นทางการ',
          'ปรับการ์ด LINE Developers ในหน้าการเชื่อมต่อระบบเป็นแบบ Minimalist Read-Only — ถอดฟอร์มแก้ไข Credentials, รหัสที่ถูกซ่อน และแถบ Webhook/LIFF URL ออกทั้งหมด เพื่อความปลอดภัยและเน้นเฉพาะข้อมูลโปรไฟล์บอท สถิติโควต้าคงเหลือ และปุ่มทดสอบการเชื่อมต่อ',
        ],
      },
    ],
  },
    ...
    groups: [
      {
        t: 'ใหม่',
        items: [
          'ระบบส่งการแจ้งเตือนผู้ใช้งานผ่าน LINE อัตโนมัติ (LINE Notification Rich Cards) เมื่อเจ้าหน้าที่กดอนุมัติ ปฏิเสธ หรือยกเลิกคำขอจอง',
          'ระบบรับเรื่อง "แจ้งปัญหา / ข้อเสนอแนะ" จากฝั่ง Client Portal — บันทึกข้อมูลลงฐานข้อมูลส่วนกลางพร้อมเลขอ้างอิงแบบปี พ.ศ. (ISS-xxxx / FDB-xxxx) เพื่อใช้ติดตามเรื่องร้องเรียนทาง LINE OA และเตรียมรองรับหน้าจอเจ้าหน้าที่ในรอบถัดไป',
          'หน้าข้อเสนอแนะ/แจ้งปัญหา (/backend/feedback) — รายการเรื่องที่ผู้ใช้ส่งผ่าน LINE พร้อมแท็บแยกประเภท ค้นหา กรองตามสถานะและสถานที่ และหน้าต่างรายละเอียดที่ดูรูปภาพแนบได้ เจ้าหน้าที่อัปเดตสถานะและเขียนบันทึกการดำเนินการภายในได้ โดยทุกครั้งที่บันทึกจะเก็บเป็นประวัติการดำเนินการ (ผู้ดูข้อมูลเปิดอ่านได้อย่างเดียว)',
          'หน้าปฏิทินการจอง (/backend/bookings/calendar) — ตรวจสอบตารางการใช้สถานที่ตลอดทั้งวันแบบ Gantt Resource Timeline 24 ชั่วโมง (00:00–24:00 น.) ตรึงแถบเวลาและชื่อสถานที่ พร้อมสวิตช์สลับมุมมองรายการแบบ Agenda รองรับการตรวจจับช่วงเวลาทับซ้อน (Clash Detection) เฉพาะคำขอรอพิจารณา และฟิลเตอร์แสดงเฉพาะสถานที่ที่มีการจองในวันนั้น',
        ],
      },
      {
        t: 'ปรับปรุง',
        items: [
          'ระบบควบคุมความเป็นส่วนตัว (Privacy D-C13) เมื่ออนุมัติคำขอแล้วเกิดการทับซ้อนจนระบบต้องปฏิเสธคำขออื่นอัตโนมัติ การ์ดแจ้งเตือนจะปกปิดรหัสคำขอที่ชนะและผู้จัดกิจกรรมเสมอ',
          'การแสดงรูปโปรไฟล์ผู้ส่งเรื่องในการ์ดผู้ส่งเรื่อง (Reporter Avatar) — ดึงรูปภาพโปรไฟล์ LINE จริงของผู้แจ้งเรื่องมาแสดงผลในการ์ดรายละเอียด พร้อม Fallback เป็นตัวอักษรย่อเมื่อไม่มีรูปภาพ',
        ],
      },
      {
        t: 'แก้ไข',
        items: [
          'การส่งข้อความแจ้งเตือนคำขอแบบใช้ซ้ำหลายวัน — ปรับข้อความตัวอย่างในห้องแชท (Alt Text) ของการ์ดแจ้งเตือน LINE ให้กระชับ ไม่เกินขีดจำกัด 400 ตัวอักษรของ LINE API',
          'แถบเลื่อนแนวนอนของตารางและแท็บ (Horizontal Scroller Gutter) — แก้ไขปัญหาช่องว่างเกิน 10px ที่ขอบขวาของตารางและแถบแท็บสถานะบนหน้าจอ Desktop โดยปรับ scrollbar-gutter ของแถบเลื่อนแนวนอนเป็น auto เพื่อไม่ให้กันพื้นที่แนวตั้งที่ไม่ได้ใช้งาน',
          'การป้องกันการ Soft Delete ข้อมูลสิ่งอำนวยความสะดวกในชุดเทส E2E — ปรับปรุงชุดเทสใน venue-options.e2e-spec.ts และ venues.e2e-spec.ts ให้ใช้ helper hideLiveAmenities() กู้คืนข้อมูลจริงและเคลียร์แคช Redis หลังจบเทสทันที เพื่อไม่ให้กระทบต่อสิ่งอำนวยความสะดวกจริงในฐานข้อมูล',
        ],
      },
    ],
  },
    ...
    groups: [
      {
        t: 'ใหม่',
        items: [
          'ระบบเพิ่มข้อมูลหลักแบบรวดเร็วในฟอร์ม (Creatable Combobox) — รองรับการพิมพ์เพิ่มตำแหน่ง, กลุ่ม/ฝ่าย, ประเภทสถานที่ และสิ่งอำนวยความสะดวกได้ทันทีจากในแบบฟอร์ม โดยไม่ต้องออกจากหน้าจอ พร้อมระบบ BroadcastChannel ซิงก์ตัวเลือกข้ามแท็บแบบ Real-time',
          'แถบแบ่งหน้ามาตรฐาน 3 ตอน (Unified PaginationBar) — ปรับใช้แถบแบ่งหน้ามาตรฐาน 3 ส่วน (สรุปช่วงข้อมูล, ปุ่มกระโดดหน้า, และตัวเลือกแถวต่อหน้าขนาด 44px) ครอบคลุมทั่วทั้ง 5 หน้าจอหลักของระบบหลังบ้าน พร้อมหน่วยนับเฉพาะของแต่ละแท็บ',
        ],
      },
      {
        t: 'ปรับปรุง',
        items: [
          'โครงสร้างความสูงตารางและการเลื่อนหน้าจอ — ปรับตารางในหน้าจัดการทั้งหมดให้มีความสูงตามเนื้อหาจริง (Natural Content Height) และรวมแถบเลื่อนแนวตั้งไว้ที่หน้าจอหลัก (<main>) จุดเดียว ขจัดปัญหาสองแถบเลื่อนซ้อนกัน (Nested Scrollbars) โดยยังคงการเลื่อนแนวนอนบนตารางขนาดกว้างไว้',
          'แท็บเริ่มต้นหน้าคำขอจองสถานที่ — เพิ่ม Fallback สลับไปยังแท็บ "ทั้งหมด" โดยอัตโนมัติหากไม่มีรายการรอพิจารณา เพื่อให้เห็นภาพรวมคำขอทันทีโดยไม่ติดค้างหน้าว่างเปล่า',
          'ระบบอัปเดตข้อมูล Real-time หน้าคำขอจองและการลงทะเบียน — ยกเลิกแบนเนอร์แจ้งเตือนแบบเดิม เปลี่ยนเป็นการโหลดข้อมูลใหม่และแสดงแถบสีเน้นแถวรายการใหม่ (Row Flash) ทันทีที่ได้รับ Real-time Event พร้อมระบบ Background Reload ที่ปลอดภัยไม่ล้างตารางเมื่อเน็ตเวิร์กขัดข้อง',
          'ระบบจัดการวงจรชีวิตคำขอจองและสถานะหมดเวลาพิจารณา — เพิ่มสถานะ "หมดเวลาพิจารณา" (EXPIRED) พร้อมแท็บตัวกรองแยกเฉพาะ และระบบ Background Worker สแกนปรับสถานะคำขอที่เลยเวลาใช้งานอัตโนมัติทุก 1 นาที พร้อมตัดยอดการแจ้งเตือนบนเมนูด้านข้างแบบ Realtime',
          'การป้องกันการปิดหน้าต่างโดยไม่ตั้งใจ — ปรับปรุง Modal ในระบบหลังบ้านทั้งหมดไม่ให้ปิดตัวลงเมื่อคลิกพื้นที่ว่างภายนอก (Backdrop) ช่วยปกป้องข้อมูลฟอร์มที่กำลังพิมพ์ไม่ให้สูญหาย โดยสามารถปิดได้ผ่านปุ่ม ✕, ปุ่มยกเลิก และปุ่ม Esc',
          'มาตรฐานตัวเลือกในแถบเครื่องมือและฟอร์มสถานที่ — อัปเกรดตัวเลือก Native Dropdown ในหน้าการลงทะเบียน, เจ้าหน้าที่ระบบ, หน้าสถานที่ และฟอร์มสถานที่ เป็น Combobox มาตรฐานความสูง 44px ขอบมน เข้ากับธีมระบบอย่างสมบูรณ์ และรองรับการพิมพ์ค้นหาประเภทสถานที่ พร้อมระบบคืนค่าเริ่มต้นอัตโนมัติ',
          'มาตรฐานตัวเลือกดรอปดาวน์ในระบบหลังบ้าน (daisyUI Select) — ปรับใช้คอมโพเนนต์ select ของ daisyUI แทน .form-shell ดั้งเดิมในแถบแบ่งหน้า (PaginationBar), ฟอร์มกลาง (SelectField) และตัวเลือกเวลาในหน้าต่างสร้างคำขอจองตรง เพื่อให้แสดงผลตัวเลือกแบบ Modern UI ขอบมนพร้อมเครื่องหมายถูกบนเบราว์เซอร์สมัยใหม่',
          'ดีไซน์ปุ่มแสดง/ซ่อนรหัสผ่านทรงวงกลม (Circular Password Eye) — ปรับแต่งปุ่มดวงตาในแบบฟอร์มให้เป็นทรงวงกลมขนาด 32px พร้อมระยะห่างสมมาตร 6px ทุกด้าน และใช้เอฟเฟกต์ Soft Highlight นุ่มนวลเมื่อ Hover หรือกด Tab แทนที่เส้นขอบซ้อนสองชั้น',
        ],
      },
      {
        t: 'แก้ไข',
        items: [
          'การแสดงผลสีไฮไลต์ของตัวเลือกในเมนูดรอปดาวน์ — แก้ไข Selector ใน admin-portal.css เป็น select:not(.select) เพื่อคืนค่าสีไฮไลต์ตอนเมาส์ชี้และเลื่อนคีย์บอร์ดในคอมโพเนนต์ select ของ daisyUI ทั้งในธีมสว่างและธีมมืด',
          ...
          'การจำกัดขอบเขตสไตล์ Badge ในระบบผู้ดูแล — ปรับแต่ง CSS Selector ใน admin-portal.css ให้จำกัดเฉพาะ [data-theme^="easybook-admin"] ป้องกันไม่ให้สไตล์ไปรบกวน Client Portal',
          'การจัดวางปุ่มการกระทำในหน้าข้อมูลการลงทะเบียน — กำหนดขนาดที่แน่นอนให้กับแถวปุ่มจัดการ (.row-actions) แก้ไขปัญหาปุ่มดูข้อมูลและปุ่มแก้ไขซ้อนทับกันบนหน้าจอเดสก์ท็อป',
          'ระบบไฮไลต์คีย์บอร์ดใน Combobox — ล็อกตำแหน่งไฮไลต์ให้อยู่ที่แถวสร้างตัวเลือกใหม่อย่างมั่นคง แม้มีข้อมูลรีโหลดจากแท็บอื่นเข้ามาขัดจังหวะ',
          'การเปลี่ยนหน้าอัตโนมัติเมื่อลบรายการสุดท้าย — ป้องกันการกะพริบหน้าจอว่าง โดยถอยกลับไปยังหน้าก่อนหน้าทันทีเมื่อแถวสุดท้ายในหน้าถูกลบหรือย้ายออก',
        ],
      },
    ],
  },
    ...
    groups: [
      {
        t: 'ใหม่',
        items: [
          'หน้าคำขอจองสถานที่ (#/bookings/requests) — หน้าจอจัดการคำขอสำหรับผู้ดูแลระบบ พร้อมตารางคิวสด, ตัวกรอง 5 สถานะ, ตัวกรองสถานที่, ระบบค้นหารหัสและผู้ขอ, และการแบ่งหน้า',
          'ชุดหน้าต่างจัดการคำขอ 5 รายการ — รายละเอียดคำขอฉบับเต็ม, หน้าต่างอนุมัติพร้อมตรวจสอบการชนเวลาอัตโนมัติ (ADR-001), หน้าต่างปฏิเสธพร้อมระบุเหตุผล, หน้าต่างยกเลิก, และหน้าต่างบันทึกการจองโดยตรงโดยเจ้าหน้าที่พร้อม Preflight Check',
          'การแจ้งเตือน Realtime ฝั่งแอดมิน — เชื่อมต่อ Socket.IO /admin อัปเดตตัวเลขคำขอรออนุมัติบนเมนูด้านข้างและแทรกคิวแถวใหม่ในตารางทันทีที่มีการเคลื่อนไหว',
          'คำสั่งทำความสะอาดรูปภาพสถานที่ตกค้าง — เพิ่ม CLI venues:sweep-photos สำหรับกวาดล้างไฟล์รูปภาพสถานที่ชั่วคราวที่ไม่ได้ผูกกับสถานที่จริงใน Cloudflare R2',
        ],
      },
      {
        t: 'ปรับปรุง',
        items: [
          'ระบบฟอนต์ Noto Sans Thai — เปลี่ยนฟอนต์ Kanit เป็น Noto Sans Thai แบบ Self-hosted ครอบคลุมทั้ง Admin Portal และ Client Portal เพื่อความชัดเจนในการอ่านข้อความราชการ',
          'ระบบฐานข้อมูลและการเรียงลำดับภาษาไทย — ปักหมุด ICU Collation (th-TH-x-icu) บน 7 ตารางหลัก พร้อมติดตั้ง sanitizeThaiText ป้องกันปัญหาการพิมพ์สระผิดเพี้ยน (เเ เป็น แ, นิคหิต+สระอา เป็น ำ, และลบอักขระล่องหน)',
          'ระบบเซิร์ฟเวอร์จำลองเพื่อการทดสอบ (Stub Server) — อัปเดตให้อ่านเลขเวอร์ชันจาก package.json อัตโนมัติ พร้อมเพิ่ม Control Endpoint (/__control/version) สำหรับจำลองสถานะ Version Mismatch บนหน้าจอ',
        ],
      },
      {
        t: 'แก้ไข',
        items: [
          'การแสดงผลตารางคำขอจอง — จำกัดความกว้างคอลัมน์สถานที่ (max-w-[126px]) และขยายพื้นที่สัมผัสรหัสคำขอบนมือถือเป็น 44px ป้องกันปัญหาตารางล้นแนวนอน',
        ],
      },
    ],
  },
    ...
    groups: [
      {
        t: 'ใหม่',
        items: [
          'หน้ารายการการจองของฉัน (#/bookings) — แสดงรายการคำขอของผู้ใช้ LINE พร้อมระบบค้นหา, ตัวกรอง 6 สถานะ, ดรอปดาวน์หมวดหมู่ตามประวัติการจองจริง, และคำนวณสถานะหมดเวลาแบบสด',
          'หน้ารายละเอียดคำขอและการยกเลิก (#/booking/:id) — แสดงรายละเอียดคำขอฉบับเต็ม พร้อมระบบกดยกเลิกคำขอทั้งใบ (สถานะรอพิจารณา) และกดยกเลิกรายช่วงเวลาตามกติกา Q-C4 (สถานะอนุมัติแล้ว)',
          'ระบบการแจ้งเตือน Toast ส่วนกลาง — ติดตั้ง ToastProvider ครอบคลุมทั่วทั้ง Client Portal เพื่อแจ้งเตือนผลการดำเนินงานทันที',
        ],
      },
    ],
  },
    ...
    groups: [
      {
        t: 'ใหม่',
        items: [
          'ฟอร์มยื่นคำขอจองสถานที่ (#/request/:id) — รองรับการจอง 2 รูปแบบ (ใช้ต่อเนื่องครั้งเดียว และ ใช้ซ้ำหลายวัน) พร้อมระบบตรวจความว่างของสถานที่แบบสด 3 ระดับตามกติกา D-C13',
          'หน้าจอยืนยันการยื่นคำขอ (#/sent/:id) — แสดงรหัสคำขอ BR-XXXX พร้อมแอนิเมชันยืนยันผล สรุปรายละเอียดคำขอ และแจ้งเตือนผลผ่าน LINE OA',
          'ระบบตรวจสอบความพร้อมของสถานที่ — เชื่อมต่อ API ดึงช่วงเวลาที่ถูกจองแล้วจากเซิร์ฟเวอร์แบบสดเพื่อแสดงบนปฏิทินและไทม์ไลน์ 24 ชม.',
        ],
      },
    ],
  },
